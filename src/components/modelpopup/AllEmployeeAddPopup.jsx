...
const AllEmployeeAddPopup = ({ update_doc }) => {
  ...
  const { 
    ...
    { resolver: yupResolver(schema),
      defaultValues: {...updateUser,
        confirm_password: updateUser?.password,
  ...
  useEffect(() => {
    if (updateUser) {
      const joinDate = updateUser?.join_date ? updateUser.join_date : null;
      setSelectedDate2(joinDate ? JSON.parse(joinDate) : null);
      reset2({
        ...updateUser,
        confirm_password: updateUser?.password,
        designation: { value: updateUser?.designation, label: updateUser?.designation },
  ...
  }, [role_perm, curr_depart, curr_desig, reset]);
        ...
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <span className="text-danger">{showerror ? showerror : showerror}</span>
                <div className="row">
      ...
      <div id="edit_employee" className="modal custom-modal fade" role="dialog">
        ...
        >
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form onSubmit={handleSubmit2(testSubmit)}>
                <div className="row">
                  <div className="col-sm-6">
                    <div className="input-block mb-3">
                      <label className="col-form-label">
