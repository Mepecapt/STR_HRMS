...
export const ClientModelPopup = () => {
  ...
  const onSubmit = data => {
    modal_adder('client', data, '/clients')
  }

  const onUpdate = data => {
    modal_updater('client', data, '/client', documentId)
  }
                ...
                <div className="row">
                  ...
                  <div className="col-md-6">
                    <div className="input-block mb-3">
                      ...
                      <input className="form-control floating" type="email" {...register('fname', {required: true})}/>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="input-block mb-3">
                      <label className="col-form-label">Password</label>
                      <input className="form-control" type="password" {...register('fname', {required: true})}/>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="input-block mb-3">
                  ...
                  <div className="col-md-6">
                    <div className="input-block mb-3">
                      ...
                      <input className="form-control floating" type="text" {...register('fname', {required: true})}/>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="input-block mb-3">
