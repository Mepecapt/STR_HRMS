...
import { Avatar_05, Avatar_09, Avatar_10, Avatar_16 } from "../../Routes/ImagePath";
import { Link } from "react-router-dom";
import DatePicker from "react-datepicker";
import Select from "react-select";
import DefaultEditor from "react-simple-wysiwyg";
...
const ProjectModelPopup = () => {
  ...
  const onSubmit = (data) => {
    const all_data = {...data, start_date: selectedDate1, end_date: selectedDate2}

    modal_adder('projects', all_data, '/projects')
  };
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <div className="row">
                ...
                <div className="col-sm-6">
                  <div className="input-block mb-3">
                    <label className="col-form-label">Client</label>
                    <Select options={companies} placeholder="Select" styles={customStyles} />
                  </div>
                </div>
              </div>
              <div className="row">
              ...
              <div className="row">
                ...
                <div className="col-sm-3">
                  <div className="input-block mb-3">
                    <label className="col-form-label">&nbsp;</label>
                    <Select options={rate} placeholder="Select" styles={customStyles} />
                  </div>
                </div>
                <div className="col-sm-6">
                  <div className="input-block mb-3">
                    <label className="col-form-label">Priority</label>
                    <Select options={status} placeholder="Select" styles={customStyles} />
                  </div>
                </div>
              </div>
              <div className="input-block mb-3">
