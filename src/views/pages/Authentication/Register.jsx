...
import { admin_objs } from "../../../utils/empObj";
...
const Register = () => {
  ...
  const onSubmit = async (data) => {
    const existingUser = admin.some(user => user.email === data.email);
    ...
    if (!existingUser) {
      try {
        ...
        .then((userCredential) => {
            ...
            const userData = admin_objs(user.uid, {email: data.email, pasword: data.password})
   
            const user_cred = {email: data.email, pasword: data.password, uid: userCredential.uid}
